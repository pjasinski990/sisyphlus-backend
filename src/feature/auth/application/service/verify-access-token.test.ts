...
import { AuthenticatedData, CreateAccessTokenStrategy, JwtAuthenticatedData, VerifyAccessTokenStrategy } from '@/feature/auth/entity/auth-strategy';
import { createJwtAccessToken, verifyJwtAccessToken } from '@/feature/auth/application/service/access-token-strategies';
import { expectResultOk } from '@/shared/util/testing/assertion';
