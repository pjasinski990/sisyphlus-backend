...
import { TaskBlock, Timeblock, UpdateBlockPayload } from '@/feature/timeblocks/entity/timeblock';
...
export class TimeblockController {
    ...
    async handleUpdateTimeblock(userId: string, patch: UpdateBlockPayload): AsyncResult<string, Timeblock> {
